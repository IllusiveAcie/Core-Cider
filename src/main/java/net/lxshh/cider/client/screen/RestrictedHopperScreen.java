...
public class RestrictedHopperScreen extends AbstractContainerScreen<RestrictedHopperMenu> {
    ...
    public RestrictedHopperScreen(RestrictedHopperMenu menu, Inventory playerInventory, Component title) {
